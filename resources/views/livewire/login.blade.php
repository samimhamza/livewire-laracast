<div class="m-auto w-1/2 mb-4">
    ...
    <form wire:submit="authenticate">
        <div class="mb-3">
            ...
            <input id="email-address" type="text" class="p-2 w-full border rounded-md bg-gray-700 text-white"
                wire:model="email">
            <div>
                @error('email')
        ...
        <div class="mb-3">
            ...
            <input id="password" type="password" class="p-2 w-full border rounded-md bg-gray-700 text-white"
                wire:model="password">
            <div>
                @error('password')
                    <span class="text-red-600">{{ $message }}</span>
